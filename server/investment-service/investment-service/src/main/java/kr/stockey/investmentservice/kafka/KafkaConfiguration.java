...
//        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderProducerDto> kafkaListenerContainerFactory2() {
        ConcurrentKafkaListenerContainerFactory<String, OrderProducerDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactory("group-id-2", "earliest", OrderProducerDto.class));
        factory.setConcurrency(3); // Set the desired level of concurrency
        return factory;
    }
